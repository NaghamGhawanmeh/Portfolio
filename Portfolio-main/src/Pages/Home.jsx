...
const WORDS = ["Driven by a love for technology and continuous learning", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js","HTML","CSS","Express.js","PostgreSQL","Bootstrap","Material UI","MongoDB", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/NaghamGhawanmeh" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/naghamghawanmeh/" },
  { icon: Mail, link: "mailto:ghawanmehnagham@gmail.com" }
];
